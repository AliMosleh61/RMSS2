...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('font_awesome/web-fonts-with-css/css/fontawesome-all.min.css')); ?>" />
    <!-- BootStrap theme css -->
    ...
    <!-- datatables  css -->
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/dataTables/jquery.dataTables.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/dataTables/responsive.dataTables.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/dataTables/buttons.dataTables.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/dataTables/select.dataTables.min.css')); ?>" />
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse " >            <!-- when we will minimize the window the nav will minimize -->
          ...
          <ul class="nav navbar-nav" >                      <!-- to make the elements be in the same line togather -->
            <li  id="navDashboard"><a href="<?php echo e(url('/home')); ?>"><i  class="glyphicon glyphicon-list-alt"></i> الشاشة الرئيسيه </a></li>
            ...
            <li class="dropdown">                      <!-- to identify this element contain another list  -->
              ...
              <ul class="dropdown-menu" >                  <!-- to hide the element of the list and make it as dropdown menu -->
                ...
                <li><a href="<?php echo e(url('/SystemConfiguration')); ?>"><i class="fas fa-cogs"></i> متغيرات النظام </a></li>
                <li><a href="<?php echo e(url('/currencies')); ?>"><i class="fas fa-dollar-sign"></i> العملات </a></li>
            ...
            <li class="dropdown">                      <!-- to identify this element contain another list  -->
              ...
              <ul class="dropdown-menu" >                  <!-- to hide the element of the list and make it as dropdown menu -->
                ...
                <li><a href="#"><i class="fas fa-cart-plus"></i> متغيرات المبيعات</a></li>
                <li class="divider"></li>
            ...
            <li class="dropdown">                      <!-- to identify this element contain another list  -->
              ...
              <ul class="dropdown-menu" >                  <!-- to hide the element of the list and make it as dropdown menu -->
                ...
                <li><a href="#">متغيرات الاصناف </a></li>
                  <li class="divider"></li>
                <li class="dropdown-header">تهيئة المخازن</li> 
                <li><a href="#">متغيرات المخازن </a></li>
            ...
            <li class="dropdown" id="MainUsersManagement">                      <!-- to identify this element contain another list  -->
              ...
              <ul class="dropdown-menu" >                  <!-- to hide the element of the list and make it as dropdown menu -->
                <li id="navUsersManagement"><a  href="<?php echo e(url('/usersManagement')); ?>"><i class="fas fa-users-cog"></i> إدارة المستخدمين </a></li>
                <li><a href="<?php echo e(url('/userConfiguration')); ?>">متغيرات المستخدمين</a></li>
                <li class="divider"></li>
              </ul>
            </li>
          </ul>
          ...
          <ul class="nav navbar-nav navbar-left">
            <li class="dropdown">                      <!-- to identify this element contain another list  -->
              ...
              <ul class="dropdown-menu" >                  <!-- to hide the element of the list and make it as dropdown menu -->
                ...
                <li><a href="<?php echo e(url('/logout')); ?>"> <i class="glyphicon glyphicon-log-out"></i> تسجيل الخروج</a></li>
              </ul>
            </li>
          </ul>
        </div>
