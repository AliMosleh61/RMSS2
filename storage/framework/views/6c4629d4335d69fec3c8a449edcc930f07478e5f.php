			            ...
			            <div class="panel-body">
						 <div class="messages">
							 ...
							 <?php endif; ?>
                               ...
                               <form class="form-horizontal" action="<?php echo e(url('/AddUser/add')); ?>" method="POST" id="submitUserForm" auto-compelet="off" >
									<?php echo e(csrf_field()); ?>
							      	...
							      	<div class="modal-body">
								       ...
								       <div class="form-group">
								        ...
								        <div class="col-sm-6">
								         <input type="text" name="empname" id="empname" class="form-control"   placeholder=" اسم الموظف " value="<?php echo e(old('empname')); ?>" >
								        </div>
								       </div>
								       ...
								       <div class="form-group">
								        ...
								        <div class="col-sm-6">
								         <input type="text" name="username" id="username" class="form-control" placeholder="اسم المستخدم " value="<?php echo e(old('username')); ?>" >
								        </div>
			      					    </div>
							         ...
							         <select class="form-control" id="UserType" name="UserType">
										 <?php if($usersTypes != null): ?>
										   <?php $__currentLoopData = $usersTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											   <option value="<?php echo e($type->id); ?>"> <?php echo e($type->Detail); ?> </option>
										   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
							         </select>
							        </div>
