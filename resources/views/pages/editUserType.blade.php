    ...
    <div class="row">
		<div class="col-md-12">
			   <ol class="breadcrumb">
				 ...
				 <li ><a href="{{url('/userConfiguration')}}">ادارة المستخدمين </a></li>
			            ...
			            <div class="panel-body">
						 <div class="messages">
							 ...
							 @endif
                               ...
                               <form class="form-horizontal" action="{{url('/editUserType/edit')}}" method="POST" id="submitUserForm" auto-compelet="off" >
									{{csrf_field()}}
							       ...
							       <div class="form-group">
							        ...
							        <div class="col-sm-6">
							         <select class="form-control" id="typeStatus" name="typeStatus">
										 ...
										 <option value="1" @if ((isset($userType) && $userType->State == 1 ) || old('typeStatus') == 1 )  selected="selected" @endif> مفعل </option>
                                         <option value="2" @if ((isset($userType) && $userType->State == 2) || old('typeStatus') == 2) selected="selected" @endif >ملغي </option>
							      ...
							      <div class="modal-footer">
							        <a href="{{url('/userConfiguration')}}" class="btn btn-default" ><i class="glyphicon glyphicon-remove-sign"></i> إلغاء </a>
